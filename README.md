...
| GET    | `/usuarios/{id}`               | Buscar usuário      | JWT                           |
...
| POST   | `/pagamentos/`                 | Processar pagamento | JWT                           |
| GET    | `/fidelidade/`                 | Consultar pontos    | CLIENTE                       |
| GET    | `/cozinha/pedidos`             | Pedidos cozinha     | ATENDENTE / GERENTE           |
| PATCH  | `/cozinha/pedidos/{id}/status` | Atualizar preparo   | ATENDENTE / GERENTE           |
...
| ATENDENTE | Criar pedido, atualizar preparo                      |
...
4. PATCH /cozinha/pedidos/{id}/status
